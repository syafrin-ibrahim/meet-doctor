          ...
          <div class="flex flex-auto justify-between">
            ...
            <a href="{{ route('index') }}" class="flex-shrink-0 flex items-center">
              <img
                ...
                src="{{ asset('assets/frontsite/images/logo_copy.png') }}"
            ...
            <div class="hidden lg:ml-6 lg:flex lg:space-x-12">
             ...
             -->
              <a
                ...
                {{ request()->is('/') ? "after:absolute after:content-[''] after:border-b-2 after:border-[#0D63F5] after:w-8/12 after:-translate-x-1/2 
                   after:bottom-3 after:left-1/2 font-semibold inline-flex items-center px-1 text-lg" : " hover:text-gray-500 inline-flex items-center px-1 pt-1 text-lg font-medium " }} ">
                Home
              </a>
              <a
                href="#"
                  ...
                  <div>
                    ...
                    >
                      ...
                      <img
                        ...
                        src="{{ asset('assets/frontsite/images/authenticated-user_copy.svg') }}"
                        alt="User Profile"
                      />
                    </button>
                  </div>
