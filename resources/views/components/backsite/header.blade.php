    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="{{ route('backsite.dashboard') }}"><img class="brand-logo" alt="modern admin logo" src="{{ asset('/assets/backsite/app-assets/images/logo/logo.png') }}">
