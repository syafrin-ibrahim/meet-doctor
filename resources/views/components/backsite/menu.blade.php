    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- @can('management_access') --}}
                <li class=" nav-item"><a href="#"><i class="bx bx-group bx-flashing"></i><span class="menu-title" data-i18n="Management Access">Management Access</span></a>
                    <ul class="menu-content">
                        {{-- @can('permission_access') --}}
                            <li class="active">
                                <a class="menu-item" href="{{ route('backsite.dashboard') }}">
