        ...
        <div  class="max-w-7xl grid lg:grid-cols-12 mx-auto pt-14 lg:pt-20 pb-20 lg:pb-28 lg:divide-x px-4 lg:px-16">
                ...
                <!-- Doctor Information -->
                    <div class="flex flex-wrap items-center space-x-5">
                        ...
                        <img
                            src="{{ asset('assets/frontsite/images/doctor-1_copy.png') }}"
                    ...
                    <form action="" x-data="{ payment: '' }" class="mt-8">
                        ...
                        <div class="relative">
                            ...
                            >
                            <img
                                src="{{ asset('assets/frontsite/images/master-card_copy.png') }}"
                        ...
                        <div class="relative">
                            ...
                            >
                            <img
                                src="{{ asset('assets/frontsite/images/visa_copy.png') }}"
                                class="max-h-[50px] inline-block"
                                alt="Master card"
                            />
                            </label>
                        ...
                        <div class="relative">
                            ...
                            >
                            <img
                                src="{{ asset('assets/frontsite/images/cirrus_copy.png') }}"
                                class="max-h-[50px] inline-block"
                                alt="Master card"
                            />
                            </label>
                        ...
                        <div class="relative">
                            ...
                            >
                            <img
                                src="{{ asset('assets/frontsite/images/mewallet_copy.png') }}"
                                class="max-h-[50px] inline-block"
                                alt="Master card"
                            />
