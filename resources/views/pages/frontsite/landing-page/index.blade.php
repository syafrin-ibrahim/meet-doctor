    ...
    <main class="min-h-screen">
      ...
      <section class="relative mt-12">
        ...
        <div class="hidden lg:block lg:absolute lg:z-10 lg:top-0 lg:right-0" aria-hidden="true">
          <img src="{{ asset('assets/frontsite/images/hero-image_copy.png') }}"
              ...
              <div class="flex flex-wrap gap-16 mt-8">
                <div class="flex items-center gap-4">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('assets/frontsite/images/service_copy.svg') }}" alt="service icon"/>
                  </div>
                  <div>
          ...
          <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 lg:gap-10 mt-10">
            <a href="{{ route('appointment.index')}}" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('assets/frontsite/images/doctor-1_copy.png') }}" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
              ...
              <div class="flex items-center justify-between mt-5">
                ...
                <div class="flex items-center space-x-2">
                  <img src="{{ asset('assets/frontsite/images/star_copy.svg') }}" alt="Star">
            ...
            <a href="src/pages/subject-consultation.html" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('assets/frontsite/images/doctor-2_copy.png') }}" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
                <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                  <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                </div>
              </div>
            ...
            <a href="src/pages/subject-consultation.html" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('assets/frontsite/images/doctor-3_copy.png') }}" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
                <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                  <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                </div>
              </div>
            ...
            <a href="src/pages/subject-consultation.html" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('assets/frontsite/images/doctor-4_copy.png') }}" class="w-full h-full bg-center bg-no-repeat object-cover object-center" alt="Doctor 1">
                <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                  <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                </div>
              </div>
